(function () {
  ...
  function initTerminal() {
    ...
    const commands = {
      ...
      about: "<strong>Sailakshmi B T</strong> — Robotics &amp; Automation Undergrad (MIT, Anna University).<br>CGPA: 9.10 | HSC: 94.16% | SSLC: 95.2%<br>Primary Directives: Embedded Hardware, Control Systems &amp; Autonomous AI.",
      ...
      projects: "ACTIVE_BUILDS:<br> &gt; Masters and Academic Tracker (React)<br> &gt; Orion Local AI Assistant (FastAPI, Llama 3.2)<br> &gt; AgileX Scout Mini ROS 2 Jazzy (ROS2, C++)<br> &gt; Student Life Concierge AI Agent (Google ADK)<br> &gt; Hand Gesture Volume Controller (OpenCV)<br> &gt; Sign Language Translator (OpenCV, MediaPipe)<br> &gt; Honors Capstone Project (MIT Robotics Honors Sem 5-7)<br> &gt; Mechanical Rotary Device (SolidWorks)<br> &gt; KiCAD Electronic Designs (PCB Design)",
